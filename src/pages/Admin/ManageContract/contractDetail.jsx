            ...
            <Descriptions column={1} bordered>
              ...
              >
                <Space direction="vertical" size={4}>
                  ...
                  <Space>
                    <Tag color="blue">
                      {contract.staffId?.departmentId?.departmentName ||
                        "No Department"}
                    </Tag>
                    <Tag
                      color={
                        contract.staffId?.role === "manager" ? "gold" : "green"
                      }
                    >
              ...
              >
                <Space direction="vertical" size={4}>
                  <Space>
                    ...
                    <Text>
                      {dayjs(contract.fromDate).format("DD MMMM YYYY")}
                    </Text>
                  </Space>
                  <Space>
                    <Text strong>To:</Text>
                    <Text>{dayjs(contract.toDate).format("DD MMMM YYYY")}</Text>
                  </Space>
                  <Space>
              ...
              >
                <Space direction="vertical" size={4}>
                  <Space>
                    ...
                    <Text>
                      {contract.createdBy?.personalInfo?.fullName || "N/A"}
                    </Text>
                  </Space>
                  <Space>
