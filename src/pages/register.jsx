import { Button, Form, Input, notification, Card, Typography, Select, Row, Col } from 'antd';
...
const RegisterPage = () => {
    ...
    const onFinish = async (values) => {
        ...
        const res = await createUserApi(name, email, password, address, phone, gender);
        ...
        <div style={{
            ...
            >
                <div style={{ textAlign: 'center', marginBottom: 24 }}>
                    <Title level={2} style={{ marginBottom: 0 }}>Đăng ký tài khoản</Title>
