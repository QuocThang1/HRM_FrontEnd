...
import { Card, Button, Typography, Spin, Tag, Calendar } from "antd";
import {
  ClockCircleOutlined,
  EnvironmentOutlined,
  CheckCircleOutlined,
    ...
    if (navigator.geolocation) {
      navigator.geolocation.getCurrentPosition(
        ...
        (error) => {
          ...
          toast.warning("Unable to get your location. Please enter manually.", {
            autoClose: 3000,
          });
        },
      );
    ...
    return (
      <div className="calendar-cell-content">
        ...
        {attendance.isLate !== undefined && (
          ...
          >
            {attendance.isLate ? `LATE ${attendance.lateMinutes}m` : "ON TIME"}
          </Tag>
        )}
      </div>
    );
            ...
            <div className="attendance-details">
              <div className="attendance-status">
                ...
                <div className="status-info">
                  ...
                  <Tag
                    color={todayAttendance.checkOut ? "blue" : "success"}
              ...
              <div className="time-info-grid">
                <div className="time-info-item">
                  ...
                  <div>
                    <Text className="time-label">Check-in Time</Text>
                ...
                <div className="time-info-item">
                  ...
                  <div>
                    <Text className="time-label">Check-in Location</Text>
                ...
                {todayAttendance.checkOut && (
                  <>
                    <div className="time-info-item">
                      <ClockCircleOutlined className="time-icon" />
                      <div>
                        <Text className="time-label">Check-out Time</Text>
                        <Text className="time-value">
                    ...
                    <div className="time-info-item">
                      <ClockCircleOutlined className="time-icon" />
                      <div>
                        <Text className="time-label">Working Hours</Text>
                        <Text className="time-value">
                ...
                {todayAttendance.isLate !== undefined && (
                  <div className="time-info-item">
                    ...
                    <div>
                      <Text className="time-label">Late Status</Text>
                      <Tag color={todayAttendance.isLate ? "orange" : "green"}>
                        {todayAttendance.isLate
                          ? `LATE (${todayAttendance.lateMinutes || 0} min)`
                          : "ON TIME"}
                      </Tag>
                    </div>
                  </div>
                ...
                {todayAttendance.isEarlyLeave !== undefined &&
                  todayAttendance.checkOut && (
                    <div className="time-info-item">
                      <ExclamationCircleOutlined className="time-icon" />
                      <div>
                        <Text className="time-label">Early Leave</Text>
                        <Tag
                          color={
                            todayAttendance.isEarlyLeave ? "orange" : "green"
                          }
                        >
