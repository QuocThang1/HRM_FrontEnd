...
const SalaryDashboard = () => {
        ...
        try {
            ...
            if (response?.EC === 0) {
                const enrichedSalaries = response.data.map((salary) => {
                    const salaryStaffId = typeof salary.staffId === 'object'
                        ? salary.staffId._id
                        : salary.staffId;

                    const staffInfo = allStaff.find(staff => staff._id === salaryStaffId);
    ...
    const filterSalaries = () => {
        if (selectedDepartment === "all") {
            ...
            const filtered = salaries.filter((salary) => {
                ...
                const staffDeptId = typeof staff.departmentId === 'object'
    ...
    const getDepartmentName = (staff) => {
        ...
        const deptId = typeof staff.departmentId === 'object'
            ? staff.departmentId._id
            : staff.departmentId;
