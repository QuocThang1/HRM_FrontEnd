...
//                 <Avatar size={64} icon={<UserOutlined />} style={{ background: '#f0f1f2', color: '#bfbfbf' }} />
//                 <Text strong style={{ marginTop: 12 }}>{auth?.user?.name || 'User'}</Text>
//             </div>
//             <Menu
//                 mode="inline"
...
//                         label: <Link to="/user/settings">Cài đặt</Link>,
//                     },
//                     {
//                         key: 'logout',
//                         icon: <LogoutOutlined />,
