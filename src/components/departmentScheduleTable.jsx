...
const DepartmentScheduleTable = ({ departmentId, staffList }) => {
  ...
  const columns = [
      ...
      render: (_, staff) => (
        <div className="staff-cell">
          ...
          <div className="staff-info">
            ...
            <Tag
              size="small"
              color={staff.role === "manager" ? "orange" : "blue"}
            >
    ...
    ...weekDates.map((date) => ({
      ...
      width: 150,
      render: (_, staff) => {
        const dayAssignments = getAssignmentsForStaffAndDate(staff._id, date);
          ...
          <div className="shift-cell">
            {dayAssignments.map((assignment) => (
              ...
              >
                ...
                >
                  {assignment.status === "scheduled" ? "S" : "C"}
                </Tag>
              </div>
            ))}
          </div>
