...
const ApplyCVPage = () => {
    ...
    const handleSubmit = async (values) => {
        ...
        try {
            ...
            if (res && res.EC === 0) {
                toast.success(res.EM || "CV submitted successfully!", { duration: 2000 });
                form.resetFields();
            } else {
                toast.error(res.EM || "Failed to submit CV. Please try again.", { duration: 2000 });
            }
        } catch (error) {
            toast.error("An error occurred while submitting your CV. Please try again.", { duration: 2000 });
        } finally {
            setLoading(false);
        }
    };
            ...
            <section className="apply-hero">
                ...
                <div className="apply-hero-content">
                    ...
                    <p className="apply-hero-subtitle">
                        Start your career journey with us. Share your CV link and we would get in touch!
                    </p>
                </div>
            </section>
                        ...
                        <Card className="apply-form-card">
                            ...
                            >
                                ...
                                <div className="cv-tips">
                                    ...
                                    <ul>
                                        <li>Upload your CV to Google Drive, Dropbox, or OneDrive</li>
                                        <li>Make sure the link is set to Anyone with the link can view</li>
                                        <li>Ensure your CV is in PDF format for best compatibility</li>
                                    </ul>
                                </div>
