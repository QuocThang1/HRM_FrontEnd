    ...
    <Modal
      title={
        <div className="modal-title">
          ...
          <span>Shifts on {date ? dayjs(date).format("DD/MM/YYYY") : ""}</span>
        </div>
      }
      open={open}
      onCancel={onClose}
              ...
              <div className="shift-detail-content">
                ...
                <div className="shift-info-grid">
                  ...
                  <div className="info-item">
                    ...
                    <div>
                      ...
                      <Text strong className="info-value">
                        {dayjs(assignment.fromDate).format("DD/MM")} -{" "}
                  ...
                  <div className="info-item">
                    ...
                    <div>
                      ...
                      <Text strong className="info-value">
                        {assignment.shiftType?.allowedLateMinute || 0} minutes
                      </Text>
                    </div>
                  </div>
                  ...
                  <div className="info-item">
                    ...
                    <div>
                      ...
                      <Text strong className="info-value">
                        {assignment.shiftType?.allowedEarlyLeaveMinute || 0}{" "}
                        minutes
                      </Text>
                    </div>
                  </div>
                ...
                {assignment.shiftType?.description && (
                  <div className="shift-description">
                    <Text type="secondary">
                      <strong>Note:</strong> {assignment.shiftType.description}
                    </Text>
                  </div>
                )}
              </div>
