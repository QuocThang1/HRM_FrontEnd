...
import { Card, Button, Calendar, Badge, Typography, Spin, Tag } from "antd";
import {
  ArrowLeftOutlined,
  PlusOutlined,
  ClockCircleOutlined,
          ...
          <div className="staff-header-info">
            <div className="staff-title-section">
              ...
              <div>
                ...
                <Text className="page-subtitle">Shift Assignment Schedule</Text>
              </div>
            </div>
            <div className="staff-meta">
              <Tag color="blue">{staff.personalInfo?.email || "N/A"}</Tag>
              <Tag color={staff.role === "manager" ? "orange" : "green"}>
