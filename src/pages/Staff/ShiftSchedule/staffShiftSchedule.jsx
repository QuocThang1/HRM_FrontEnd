...
import { Card, Calendar, Badge, Typography, Spin, Empty } from "antd";
import {
  CalendarOutlined,
  ClockCircleOutlined,
  InfoCircleOutlined,
...
const StaffShiftSchedulePage = () => {
  ...
  const upcomingShifts = assignments
    .filter((a) => {
      ...
      return (
        a.status === "scheduled" && fromDate.isAfter(dayjs().subtract(1, "day"))
      );
    })
  ...
  return (
    <div className="staff-shift-schedule-page">
                ...
                <div key={shift._id} className="upcoming-shift-item">
                  ...
                  <div className="shift-details">
                    ...
                    <div className="shift-period">
                      {dayjs(shift.fromDate).format("DD/MM/YYYY")} -{" "}
      ...
      <ShiftDetailsModal
        ...
        date={selectedDate}
        assignments={selectedDate ? getAssignmentsForDate(selectedDate) : []}
      />
    </div>
  );
};
