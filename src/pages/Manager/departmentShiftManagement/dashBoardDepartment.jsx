...
const ManagerDepartmentPage = () => {
  ...
  const isManager = (staff) => {
    return (
      staff._id === department?.managerId?._id ||
      staff._id === department?.managerId
    );
  };
          ...
          <div className="dept-header-info">
            ...
            >
              ...
              <button
                ...
                onClick={() =>
                  navigate(
                    `/profile/department-shift-management/${department._id}`,
                  )
                }
              >
                <ClockCircleOutlined />
      ...
      <div className="content-wrapper">
          ...
          <Col xs={24} sm={12} lg={6}>
            <Card className="stat-card">
              <Statistic
                ...
                value={department.managerId?.personalInfo?.fullName || "N/A"}
        ...
        >
          {staffLoading ? (
            ...
            <Row gutter={[24, 24]}>
              {staffList.map((staff) => (
                <Col xs={24} sm={12} md={8} lg={6} xl={4} key={staff._id}>
                  <Card
                    className={`staff-item-card ${
                      isManager(staff) ? "manager" : ""
                    }`}
                    hoverable={staff.role === "staff"}
                    onClick={() => {
                      if (staff.role === "staff") {
                        navigate(
                          `/profile/staff-shift-assignment/${staff._id}`,
                        );
                      }
                    }}
                    style={{
                  ...
                  >
                    ...
                    <div className="staff-info">
                      <Title level={5} className="staff-name">
                      ...
                      <div className="contact-info">
                        {staff.personalInfo?.email && (
                          <div className="contact-item">
                            ...
                            <Text className="contact-text" ellipsis>
                              {staff.personalInfo.email}
                            </Text>
                          </div>
                        )}

                        {staff.personalInfo?.phoneNumber && (
                          <div className="contact-item">
