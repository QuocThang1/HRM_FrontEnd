...
const AboutPage = () => {
    const stats = [
        { title: "Years of Experience", value: 10, suffix: "+", icon: <TrophyOutlined /> },
        { title: "Happy Clients", value: 500, suffix: "+", icon: <HeartOutlined /> },
    ...
    const coreValues = [
        {
            icon: <BulbOutlined />,
            title: "Innovation",
            description: "We constantly innovate to provide cutting-edge HR solutions that meet modern workforce needs.",
        },
        {
            icon: <SafetyOutlined />,
            title: "Trust & Security",
            description: "Your data security and privacy are our top priorities. We maintain the highest security standards.",
        },
        {
            icon: <TeamOutlined />,
                        ...
                        <Row gutter={[48, 48]} align="middle">
                            <Col xs={24} lg={12}>
                                <div className="about-text">
                                    ...
                                    <p className="about-description">
                                        Our platform combines cutting-edge technology with intuitive design to streamline HR
                                        processes, enhance employee engagement, and drive organizational success. We serve
                                        companies of all sizes, from startups to enterprises, across multiple industries worldwide.
                                    </p>
                                </div>
                            </Col>
                            <Col xs={24} lg={12}>
                                <div className="about-mission">
                                    <Card className="mission-card">
                                        ...
                                        <p>
                                            To empower organizations with innovative HR technology that simplifies workforce
                                            management and unlocks human potential.
                                        </p>
                                    </Card>
                                    <Card className="mission-card">
                                        <h3>
                                ...
                                <Col xs={12} sm={12} lg={6} key={index}>
                                    <Card className="stat-card">
                                        ...
                                        <Statistic
                                            ...
                                            value={stat.value}
                                            suffix={stat.suffix}
                                            valueStyle={{ color: "#2563eb", fontSize: "36px", fontWeight: "bold" }}
                                        />
                                    </Card>
                                </Col>
                            ))}
                    ...
                    <div className="container">
                        <div className="cta-content">
                            ...
                            <p className="cta-subtitle">
                                Join thousands of companies that trust Personnel Hub for their HR needs
                            </p>
