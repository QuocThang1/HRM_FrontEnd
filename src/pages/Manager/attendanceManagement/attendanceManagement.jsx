...
const ManagerAttendanceManagement = () => {
  ...
  const presentCount = attendances.filter((a) => a.checkIn && !a.isLate).length;
  ...
  const columns = [
    {
      ...
      render: (checkIn) => (
        <div className="date-cell">
          ...
          <div>
            <div className="date-day">{dayjs(checkIn).format("DD MMM")}</div>
            <div className="date-weekday">{dayjs(checkIn).format("ddd")}</div>
          </div>
        </div>
      ),
    },
        ...
        return (
          <div className="staff-cell">
            <Avatar
              size={40}
              style={{
                backgroundColor: getAvatarColor(staff?.personalInfo?.fullName),
              }}
            >
          ...
          <div className="legend-content">
            ...
            <div className="legend-items">
              <div className="legend-item">
                ...
                <Text type="secondary">Arrived within allowed time</Text>
              </div>
              <div className="legend-item">
                <Tag color="orange" icon={<WarningOutlined />}>
                  Late
                </Tag>
                <Text type="secondary">Arrived after allowed time</Text>
              </div>
              <div className="legend-item">
                <Tag color="blue">Working Hours</Tag>
                <Text type="secondary">Total hours worked</Text>
              </div>
            </div>
          </div>
        </Card>
