    ...
    return (
        ...
        >
            ...
            <div className="validation-summary">
                <div className="summary-item">
                    ...
                    <span className="summary-value">
                        <Tag color={validation.completionRate === 100 ? "success" : "warning"}>
                ...
                <div className="summary-item">
                    ...
                    <span className="summary-value">{validation.missingFields.length}</span>
                </div>
            </div>
            ...
            <Descriptions bordered column={1} size="small">
                ...
                <Descriptions.Item label="Date of Birth" labelStyle={{ fontWeight: 600 }}>
                    {extractedData.dob ? (
                        <span style={{ color: "#52c41a" }}>
