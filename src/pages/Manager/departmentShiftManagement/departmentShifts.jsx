...
const DepartmentShiftsPage = () => {
    ...
    const handleAddShift = async (shiftTypeId) => {
        try {
            const res = await addShiftToDepartmentApi(
                departmentId,
                shiftTypeId
            );
            ...
            toast.error(
                error.response?.data?.EM || "Failed to add shift",
                { autoClose: 2000 }
            );
            throw error;
        }
    ...
    const handleToggleStatus = async (shiftId, currentStatus) => {
        try {
            const res = await updateDepartmentShiftStatusApi(
                shiftId,
                !currentStatus
            );
                                    ...
                                    <Card className="shift-item-card">
                                        ...
                                        <div className="shift-info">
                                            ...
                                            <div className="info-row">
                                                ...
                                                <Text>
                                                    {shift.shiftType?.allowedLateMinute || 0}{" "}
                                                    min
                                                </Text>
                                            </div>
                                            <div className="info-row">
                                                ...
                                                <Text>
                                                    {shift.shiftType?.allowedEarlyLeaveMinute ||
                                                        0}{" "}
                                                    min
                                                </Text>
                                            </div>
